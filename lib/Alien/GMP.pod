...
This module looks for version 5.0.4 or greater of the GNU Multiple Precision
(GMP) library. If not found, it compiles and installs it to the Alien-GMP
distribution's shared directory.

During installation, version 5.0.4 of the GMP library source is downloaded from
its official website, L<http://www.lysator.liu.se/~nisse/nettle>.
